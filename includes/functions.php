...
function create_user($db, $fn, $ln, $email, $phone, $dob, $address, $nationality, $state, $pwd, $accBal, $cvc) {
    $query = "INSERT INTO customer (f_name, l_name, email, phone, dob, addr, nation, state, pwd, acct_bal, cvc) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
...
//            die(var_dump($usr_exists));
//            var_dump($usr_exists);
            $_SESSION['id'] = $usr_exists['customer_id'];
            $_SESSION['fn'] = $usr_exists['f_name'];
            $_SESSION['ln'] = $usr_exists['l_name'];
            $_SESSION['eml'] = $usr_exists['email'];
            $_SESSION['ph'] = $usr_exists['phone'];
            $_SESSION['dob'] = $usr_exists['dob'];
            $_SESSION['adr'] = $usr_exists['addr'];
            $_SESSION['nat'] = $usr_exists['nation'];
            $_SESSION['stt'] = $usr_exists['state'];
            $_SESSION['pwd'] = $usr_exists['pwd'];
            $_SESSION['accBal'] = $usr_exists['acct_bal'];
